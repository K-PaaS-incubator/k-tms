    ...
    return Backbone.View.extend({
        ...
        getListData: function() {
            this.sensorCollection.fetch({
                method: 'POST',
                url: 'api/securityPolicy/selectAuditLogPolicyWarningSensorList',
            ...
            this.consoleCollection.fetch({
                method: 'POST',
                url: 'api/securityPolicy/selectAuditLogPolicyWarningConsoleList',
                contentType: 'application/json',
                data: JSON.stringify({}),
                async: false,
                success: function(collection) {
...
//				updateParams = _.extend(updateParams, updateSensorParams,updateManagerParams,updateConsoleParams);
                ...
                if (updateParams != undefined && updateParams.length > 0) {
                    this.allCollection.fetch({
                        method: 'POST',
                        url: 'api/securityPolicy/updateAuditLogPolicyWarningList',
                        contentType: 'application/json',
