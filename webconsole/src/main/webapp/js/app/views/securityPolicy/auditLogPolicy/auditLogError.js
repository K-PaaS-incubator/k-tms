    ...
    return Backbone.View.extend({
        ...
        getSensorListData: function() {
            this.sensorCollection.fetch({
                method: 'POST',
                url: 'api/securityPolicy/selectAuditLogPolicyErrorSensorList',
        ...
        getConsoleListData: function() {
            this.consoleCollection.fetch({
                method: 'POST',
                url: 'api/securityPolicy/selectAuditLogPolicyErrorConsoleList',
                contentType: 'application/json',
                data: JSON.stringify({}),
                async: false,
                success: function(collection) {
        ...
        addOne: function(model) {
            ...
            if (this.editable == false) {
                type = 'info';
                // 긴급알람, 가시가청, 프로그램알림, 메일전송, sms의 알람 여부를 확인한다.
                ...
                model.set({
                    secondType1: alarmTypeVal[0],
                    secondType2: alarmTypeVal[1],
                    secondType3: alarmTypeVal[2],
                    secondType4: alarmTypeVal[3],
                    secondType5: alarmTypeVal[4],
...
//				updateParams = _.extend(updateParams, updateSensorParams, updateManagerParams, updateConsoleParams);
                ...
                if (updateParams != undefined && updateParams.length > 0) {
                    ...
                    this.allCollection.fetch({
                        method: 'POST',
                        url: 'api/securityPolicy/updateAuditLogPolicyErrorList',
                        contentType: 'application/json',
