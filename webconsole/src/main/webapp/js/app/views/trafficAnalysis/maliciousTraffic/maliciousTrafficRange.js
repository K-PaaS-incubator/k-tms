define(function (require) {
    ...
    var MaliciousTrafficSearchModel = require('models/trafficAnalysis/maliciousTrafficSearchModel');
    ...
    return Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            _.bindAll(this, "retrieve", "customOn", "customOff");
        ...
        renderTab: function (e) {
            ...
            var model = new MaliciousTrafficSearchModel(this.model.toJSON());
