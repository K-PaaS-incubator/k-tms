    ...
    var initialize = function(state){
      ...
      var size_checking = function(){
        ...
        if($('.scroll_tab_inner', _this)[0].scrollWidth > panel_width){
          ...
          if($('.scroll_tab_inner > span:not(.scroll_tab_right_finisher):not(.scroll_tab_left_finisher):visible', _this).length > 0){
    ...
    this.each(function(){
      ...
      ret.push({
        ...
        refreshFirstLast: function(){
          ...
          if($('.scroll_tab_inner > span:not(.scroll_tab_right_finisher):not(.scroll_tab_left_finisher):visible', context_obj).length > 0){
