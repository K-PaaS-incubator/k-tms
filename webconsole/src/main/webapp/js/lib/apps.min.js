		...
		$(".theme-panel [name=sidebar-fixed]").on("change", function() {
			if ($(this).val() == 1) {
				if ($(".theme-panel [name=header-fixed]").val() == 2) {
					console.log("Default Header with Fixed Sidebar option is not supported. Proceed with Fixed Header with Fixed Sidebar.");
		...
		$(".theme-panel [name=header-fixed]").on("change", function() {
			if ($(this).val() == 1) {
				...
				if ($(".theme-panel [name=sidebar-fixed]").val() == 1) {
					console.log("Default Header with Fixed Sidebar option is not supported. Proceed with Default Header with Default Sidebar.");
