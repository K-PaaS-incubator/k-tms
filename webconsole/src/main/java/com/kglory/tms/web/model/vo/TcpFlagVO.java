...
public class TcpFlagVO extends CommonBean implements Serializable{

	private static final long serialVersionUID = 9150831514351040520L;
	...
	public String toString() {
		return "TcpFlagVO [strName=" + strName + ", ucType=" + ucType
