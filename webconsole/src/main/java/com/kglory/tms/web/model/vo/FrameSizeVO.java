...
public class FrameSizeVO extends CommonBean implements Serializable{
	private static final long	serialVersionUID = 5462543357739048593L;
	...
	public String toString() {
		return "FrameSizeVO [strName=" + strName + ", ucType=" + ucType
				...
				+ ", rNum=" + rNum + ", prevRNum=" + prevRNum + ", prevBps="
				+ prevBps + ", prevPps=" + prevPps + ", prevCps=" + prevCps
				...
				+ prevIngressCps + ", prevEgressCps=" + prevEgressCps + "]";
	}
