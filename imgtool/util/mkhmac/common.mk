...
all: $(target_job) $(local_target_job)
...
install: $(local_target_job) $(install_job) $(local_install_job)
...
$(OBJ_EXE): $(OBJ_OBJS) $(SUB_OBJS)
	...
	$(CPP) -o $(LDFLAGS) $@ $(filter %.o, $^) `cat $(IMPORT_NAME)` $(ldflags) 
else
$(OBJ_EXE): $(OBJ_OBJS)
...
local-cleanall:
	rm -rf .config *.o svn-*.tmp  *~ a.out core $(OBJS) $(OBJ_OBJS) $(LOBJS) $(OBJ_LOBJS) $(SLOBJS) $(OBJ_SLOBJS) $(OBJ_TARGET) $(DEPS) $(DEPEND_FILE) $(DEPEND_BAK) $(CSCOPE_FILE) $(CTAGS_FILE) .rel .obj .libs $(STUB_H) $(STUB_S) $(EXP_TARGET) 
