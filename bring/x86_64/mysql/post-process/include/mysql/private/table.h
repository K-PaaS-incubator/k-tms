...
enum enum_table_category
{
  ...
  */
  /*
    note: Fixing the performance issues of I_S will lead
...
public:
  ...
  */       
  ...
  /*
    note: Each of the following flags take up 8 bits. They can just as easily
  ...
  */
  ...
  /*
    ...
    note: To attach the partitioning expressions to this arena.  
  */
...
/*
  ...
  2) view (TABLE_LIST::view != NULL)
     ...
     - tmptable (TABLE_LIST::effective_algorithm == VIEW_ALGORITHM_TMPTABLE)
           also (TABLE_LIST::field_translation == NULL)
  2.5) note: Add derived tables description here
  3) nested table reference (TABLE_LIST::nested_join != NULL)
     - table sequence - e.g. (t1, t2, t3)
       note: how to distinguish from a JOIN?
     - general JOIN
       note: how to distinguish from a table sequence?
     - NATURAL JOIN
...
struct TABLE_LIST
{
  ...
  */
  ...
  /* note: check if this can be joined with tablenr_exec */
  uint jtbm_table_no;
  ...
  */
  ...
  table_map     map_exec;
  /* note: check if this can be joined with jtbm_table_no */
  uint          tablenr_exec;
  ...
  */
  ...
  /* note: replace with derived_type */
  bool          merged;
