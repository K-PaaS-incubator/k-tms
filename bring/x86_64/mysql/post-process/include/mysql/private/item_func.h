...
public:
  ...
  {
    /*
      note: Make a member in UDF_INIT and return if a UDF is deterministic or
      not.
...
public:
  ...
  bool check_vcol_func_processor(uchar *int_arg) 
  {
    /* note: consider adding in support for the MATCH-based virtual columns */
    return trace_unsupported_by_check_vcol_func_processor(func_name());
  }
};
