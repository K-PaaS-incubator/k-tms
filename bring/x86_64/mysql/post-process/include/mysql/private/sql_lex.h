...
protected:
  /**
    ...
    note: with time, attributes from LEX should move to sub classes of
...
struct LEX: public Query_tables_list
{
  ...
  */
  ...
  /*
    ...
    of the query.
    note: possibly this it is incorrect to have used tables in LEX because
...
public:
  ...
  */
  ...
  /*
    note: move more attributes from the LEX structure here.
  */
};
