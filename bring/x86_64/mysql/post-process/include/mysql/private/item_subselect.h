...
/**
  ...
  This class has: 
   ...
   - Transformation methods (note: more on this).
...
public:
  ...
  */
  ...
  void add_strategy (uchar strategy)
  {
    ...
    /*
      note: PS re-execution breaks this condition, because
...
public:
  ...
  */
  ...
  /*
    note: factor out all these methods in a base subselect_index_engine class
...
public:
  ...
  uint cols() { /* note: what is the correct value? */ return 1; }
  ...
  {
    /*
      note: It is completely unclear what is the semantics of this
