...
/*
  ...
  note: move subquery of INSERT ... SELECT and CREATE ... SELECT to
...
public:
  ...
  */
  uint32 max_length;
  /*
    note: convert name and name_length fields into LEX_STRING to keep them in
...
/**
  ...
  note: Item_copy should be made an abstract interface and Item_copy_
...
public:
  ...
  {
    field= arg_field;
    /* note: take the memory allocation below out of the constructor. */
